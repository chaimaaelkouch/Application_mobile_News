...
class NewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set click listeners for CircleImageViews
        ...
        binding.businessImage.setOnClickListener {
            ...
            val businessNews = getNewsByCategory("Economies")
            updateNewsList(businessNews)
        }
        ...
        binding.techImage.setOnClickListener {
            ...
            val techNews = getNewsByCategory("Santés")
            updateNewsList(techNews)
        }
    }
    ...
    private fun dataIn() {
        liste.addAll(
            listOf(
                ...
                News(5, getString(R.string.Titre_News5_sport), getString(R.string.Desc_News5_sport), R.drawable.img5, "Business"),
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                // Filtrez les données ici en fonction de la requête
                query?.let { searchNews(it) }
                return true
            }

            override fun onQueryTextChange(newText: String?): Boolean {
                // Si vous voulez effectuer une recherche instantanée à mesure que l'utilisateur tape, mettez le code ici
                return false
            }
        })
    }
